...
var _user$project$Quote$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('quote'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: _elm_lang$html$Html$text(
								_marcosh$elm_html_to_unicode$ElmEscapeHtml$unescape(model.quote)),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('quotee'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									_marcosh$elm_html_to_unicode$ElmEscapeHtml$unescape(model.name)),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$Quote$Quote = F2(
	function (a, b) {
		return {name: a, quote: b};
	});
var _user$project$Quote$quotes = function (locale) {
	var _p1 = locale;
	switch (_p1) {
		case 'nl':
			return {
...
var _user$project$Quote$quote = F2(
	function (locale, index) {
		return A2(
			_elm_lang$core$Maybe$withDefault,
			A2(_user$project$Quote$Quote, 'Gaston', 'TESTKE'),
			A2(
				_elm_community$list_extra$List_Extra$getAt,
				index,
				_user$project$Quote$quotes(locale)));
	});
var _user$project$Quote$init = function (config) {
	var seed0 = _elm_lang$core$Random$initialSeed(config.seed);
	var locale = config.locale;
	var local_quotes = _user$project$Quote$quotes(locale);
	var upper_limit = _elm_lang$core$List$length(local_quotes) - 1;
	var _p2 = A2(
		_elm_lang$core$Random$step,
		A2(_elm_lang$core$Random$int, 0, upper_limit),
		seed0);
	var index = _p2._0;
	return {
		ctor: '_Tuple2',
		_0: A2(_user$project$Quote$quote, locale, index),
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
var _user$project$Quote$main = _elm_lang$html$Html$programWithFlags(
	{
		init: _user$project$Quote$init,
		view: _user$project$Quote$view,
		update: _user$project$Quote$update,
...
var _user$project$Quote$Config = F2(
	function (a, b) {
		return {seed: a, locale: b};
	});
var _user$project$Quote$NoOp = {ctor: 'NoOp'};
